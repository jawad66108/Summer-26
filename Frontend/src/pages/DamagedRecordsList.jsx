  ...
  return (
    <Layout>
      <div className="topbar">
        ...
        {isAdmin && (
          <button className="btn btn-primary display" onClick={() => navigate('/damaged-records/new')}>
            + Report Damaged Item
          </button>
        )}
      </div>
      ...
      <div className="panel">
        ...
        {!loading && !error && records.length === 0 && <div className="empty-note">No damaged records match these filters.</div>}
